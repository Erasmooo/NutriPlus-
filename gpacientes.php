    ...
    <div class="department_container">
      <div class="container ">
        <div class="heading_container heading_center">
          ...
          <p>
            Esta pagina é dedicada a gestão dos pacientes
          </p>
        </div>
                ...
                <tbody>
                    ...
                    <?php while($dado = $mysql ->fetch_array()){ ?>
                        <tr>
                            ...
                            <td><?php echo $dado['circunferenciaBraco']; ?></td>
                            <td><?php echo $dado['circunferenciaCintura']; ?></td>
                            <td><?php echo $dado['doencaCronica']; ?></td>
                            <td><?php echo $dado['alergia']; ?></td>
                            
                            <td><a href='actualizarP.php?id=<?php echo $dado["id"]; ?>'  class="btn">Atualizar</a></td>

                            <td><a href='apagarP.php?id=<?php echo $dado["id"]; ?>' class="btnA">Apagar</a></td>
                        </tr>
                    <?php } ?> 
                    </tr>
